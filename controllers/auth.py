...
from controllers.schemas.auth import UserSchema, TokenData
...
async def get_current_user(token: Annotated[str, Depends(oauth2_scheme)],
                           db_repository: SQLDBRepository = Depends(get_sql_db_repository)):
    ...
    user = uc.get_user_by_username(username=token_data.username)
    if user is None:
        raise credentials_exception
    return user
